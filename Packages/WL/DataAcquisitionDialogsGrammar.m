...
<dad-global> = <dad-global-show-all> | <dad-global-quit> | <dad-global-help> | <dad-global-cancel> | <dad-global-priority-list> ;
<dad-global-help> = 'help' <@ DADGlobal[\"help\"]& ;
<dad-global-quit> = 'quit' | 'exit' | 'halt' <@ DADGlobal[\"quit\"]& ;
<dad-global-cancel> = 'start' , 'over' | 'cancel' <@ DADGlobal[\"cancel\"]& ;
<dad-global-show-all> = ( 'show' | 'display' | 'echo' ) , 'all' , [ [ 'data' ] , [ 'records' ] | 'datasets' ] <@ DADGlobal[\"showall\"]& ;
